...
const CandidateCard = ({ candidate, onVote, electionId, disabled = false, loading = false }) => {
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        // Button Styling: High contrast, prominent color (blue), clear disabled state
        className={`w-full mt-3 font-bold uppercase tracking-wider px-5 py-3 rounded-xl transition-all duration-200 shadow-lg ${
          disabled 
