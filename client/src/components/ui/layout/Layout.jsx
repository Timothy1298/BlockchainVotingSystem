...
export const Sidebar = ({ activeTab, onTabChange, mobileOpen = false, onClose, compact = false }) => {
  ...
  if (isAdmin) {
    ...
    tabs.push({ id: 'analytics', label: 'Analytics', icon: BarChart2, to: '/analytics' });
    tabs.push({ id: 'blockchain-health', label: 'Blockchain Health', icon: Shield, to: '/blockchain-health' });
    tabs.push({ id: 'notifications', label: 'Notifications', icon: Bell, to: '/notifications' });
    tabs.push({ id: 'system-monitoring', label: 'System Monitoring', icon: Shield, to: '/system-monitoring' });
    tabs.push({ id: 'settings', label: 'Admin Settings', icon: Settings, to: '/admin-settings' });
  }
