            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <motion.button
                  ...
                  onClick={() => {
                    if (window.confirm('Are you sure you want to clear all candidates? This action cannot be undone.')) {
                      // Clear all candidates logic
                      showToast('Feature coming soon: Clear all candidates', 'info');
                    }
                  }}
                  disabled={election.candidateListLocked}
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => {
                    // Export candidates logic
                    showToast('Feature coming soon: Export candidates', 'info');
                  }}
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => {
                    // Import candidates logic
                    showToast('Feature coming soon: Import candidates', 'info');
                  }}
